...
public class GamePlay {
    ...
    public int checkPaperResult(ShifuEnum playerShifu, ShifuEnum botShifu) {
        ...
        if (playerShifu == botShifu) {
            System.out.print("Egaliter Vous : " + playerShifu.name()
                    + " BOT : " + botShifu.name());
            return 0;
        } else if (botShifu == ShifuEnum.ROCK) {
            System.out.print("Gagner Vous : " + playerShifu.name()
                    + " BOT : " + botShifu.name());
            return 1;
        } else if (botShifu == ShifuEnum.SCISSOR) {
            System.out.print("Perdu Vous : " + playerShifu.name()
                    + " BOT : " + botShifu.name());
            return -1;
        }
